...
class MLHoneywordGenerator:
    def __init__(self, password_list:list[str]=None, embedding_dim=50, lstm_units=100):
        ...
        self.model_file_path:str = os.path.join('utilities', 'HPGResources', 'tf_resources', "models", self.version) + ".keras"
    ...
    def visualize_model(self):
        visualization_folder_path =  os.path.join('utilities', 'HPGResources', 'tf_resources', 'visualization')
    ...
    def _prepare_dataset(self):
        ...
        """
        dataset_file_path =  os.path.join('utilities', 'HPGResources', 'tf_resources', "datasets", self.dataset_name) + ".txt"
    ...
    def train(self, epochs=100, batch_size=32):
        ...
        checkpoint_file_path =  os.path.join('utilities', 'HPGResources', 'tf_resources', "model_checkpoints", f"{self.version}_epoch{{epoch:02d}}") + ".keras"
